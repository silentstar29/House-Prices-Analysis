...
// Trace 1 - YearRemodAdd & SalePrice using train dataset

var trace1 = {
    x:data.map(row => row.YearRemodAdd_train),
...
// Trace 2 - YearRemodAdd & SalePrice using test dataset
...
// Layout
var layout = {
    title: "Sale Price vs. Year Remodeling Added",
    xaxis: {
        title: {
          text: "Year Remodeled",
        },
